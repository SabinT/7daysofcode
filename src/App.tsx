  ...
  return (
    <div className="App">
      ...
      <ol>
        ...
        <li>Share your work on social media with the tag <strong>#7daysofcode</strong>. (no need to share code)</li>
      ...
      <ol>
        ...
        <li>Got questions? Need help? Have suggestions? Send an email to <strong>info</strong> <strong>at</strong> <strong>7daysofcode.art</strong> (or file an issue on <a href='https://github.com/SabinT/7daysofcode'>github</a>)</li>
      </ol>
